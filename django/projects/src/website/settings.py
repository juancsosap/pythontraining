...
SECRET_KEY = 'cm+z@x+@s#b)3ma)k*w$&t@a40&#eu)-5hhoymvhj6dq&fktv3'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [] 
# ALLOWED_HOSTS = ['www.my-sapro.com'] 
...
EMAIL_HOST_USER = 'juan.c.sosa.p@gmail.com'
EMAIL_HOST_PASSWORD = 'Ed1d3n5Valcrost-217-Google'
EMAIL_PORT = 587

# Debug Emails
ADMIN = (('Your Name', 'juan.c.sosa.p@gmail.com'),)
