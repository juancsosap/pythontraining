...
CREATE TABLE `Country` (
  ...
  `Continent` char(26) NOT NULL default '', -- enum('Asia','Europe','North America','Africa','Oceania','Antarctica','South America') NOT NULL default 'Asia',
...
CREATE TABLE `CountryLanguage` (
  ...
  `IsOfficial` char(1) NOT NULL default '', -- enum('T','F') NOT NULL default 'F',
