...
class Item:
    def __init__(self, game, xg=0, yg=0, widthg=0, heightg=0):
        self.game = game
    ...
    def ungridx(self, x):
        return x * self.game.gridshape[0] / self.game.size[0] 

    def ungridy(self, y):
        return y * self.game.gridshape[1] / self.game.size[1] 
...
class HLine(Item):
    def __init__(self, game, xg_ini, xg_end, yg, linewidthg, color):
        super().__init__(game, xg_ini, yg, xg_end - xg_ini, linewidthg)
...
class VLine(Item):
    def __init__(self, game, xg, yg_ini, yg_end, linewidthg, color):
        super().__init__(game, xg, yg_ini, linewidthg, yg_end - yg_ini)
...
class Text(Item):
    def __init__(self, game, text, color, xg, yg):
