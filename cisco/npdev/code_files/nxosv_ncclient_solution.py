...
def main():
    ...
    with manager.connect(host='nxosv', port=22, username='cisco', password='cisco',
        ...
        # nxosv(config-if)# end
        vlan_300_commands = ['configure terminal', 'feature interface-vlan', 'interface vlan 300', 'ip address 198.51.100.10/24']
        ...
        show_interface_vlan_300_filter = """<show><interface><ifid>Vlan300</ifid></interface></show>"""
        ...
        print("Mask value is - " + nc_get_reply_no_ns.find('.//' + 'svi_ip_mask').text)
