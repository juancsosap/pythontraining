...
def main():
    ...
    #name_pwd = {'aaaUser': {'attributes': {'name': '<Replace for Q1>', 'pwd': '<Replace for Q1>'}}}
    
    # Log in to APIC
    print("Login\n**")
    #response = requests.<Replace for Q1>(base_url + '<Replace for Q1>.json', data=json.dumps(name_pwd), verify=False)
    ...
    #tn_name = <Replace for Q2>

    # Get tenant
    #print('Get ' + tn_name + '\n**')
    #response = requests.<Replace for Q2>(create_tn_url(<Replace for Q2>), cookies=cookies, verify=False)
    #Show result
    ...
    #tenant_data = create_tn_structure(<Replace for Q3>)
    #show_json_data(json.dumps(tenant_data))
    #response = requests.<Replace for Q3>(create_tn_url(<Replace for Q3>), data=json.dumps(tenant_data), cookies=cookies, verify=False)
    # Show result
    #show_json_response(response)
    ...
    #BD_name = <Replace for Q4>
    # Make request to create BD
    #print('Creating ' + BD_name + '\n**')
    #BD_data = create_BD_structure(<Replace for Q4>, <Replace for Q4>)
    #show_json_data(json.dumps(BD_data))
    #response = requests.<Replace for Q4>(create_BD_url(<Replace for Q4>, <Replace for Q4>), data=json.dumps(BD_data), cookies=cookies, verify=False)
    # Show result
    #show_json_response(response)
    ...
    #ap_name = <Replace for Q5>
    #epg_name = <Replace for Q5>
    # Make request to create application
    #print('Creating ' + ap_name + '\n**')
    #ap_data = create_ap_structure(<Replace for Q5>, <Replace for Q5>, <Replace for Q5>, <Replace for Q5>)
    #show_json_data(json.dumps(ap_data))
    #response = requests.<Replace for Q5>(create_ap_url(<Replace for Q5>, <Replace for Q5>), data=json.dumps(ap_data), cookies=cookies, verify=False)
    # Show result
    #show_json_response(response)
    ...
    #query_target = '<Replace for Q6>'
    #print('Get ' + tn_name + ' with query-target ' + query_target + '\n**')
    #response = requests.<Replace for Q6>(create_tn_url(<Replace for Q6>)+'?query-target='+query_target, cookies=cookies, verify=False)
    # Show result
    #show_json_response(response)
    ...
    #response = requests.<Replace for Q7>(base_url+'/class/<Replace for Q7>', cookies=cookies, verify=False)
    # Show result
    ...
    #Make request to delete Tenant
    #print('Delete ' + tn_name + '\n**')
    #response = requests.<Replace for Q8>(create_tn_url(<Replace for Q8>), cookies=cookies, verify=False)
    #show_json_response(response)
